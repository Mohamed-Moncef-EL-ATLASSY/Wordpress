<?php
/*
Plugin Name: Leven Tracking, External CSS and JS
 ...
 */
function leven_tracking_wp_head()
{
...
add_action('wp_head', 'leven_tracking_wp_head');
/* ================================================================================================ */

/**
 * LMPixels Adding tracking & external js to the body
 */
function leven_tracking_wp_body()
{
...
add_action('wp_footer', 'leven_tracking_wp_body');
/* ================================================================================================ */