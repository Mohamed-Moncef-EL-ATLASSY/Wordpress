				                                        ...
				                                        if ( ! empty( $thumbnails ) ) :
				                                            ...
				                                            <div class="owl-carousel portfolio-page-carousel">
				                                                <?php foreach ( $thumbnails as $thumbnail ) :
				                                                    ...
				                                                    $image = $thumbnail;
				                                                    ?>
				                                                    <img src="<?php echo esc_url($image['url']) ?>" alt="<?php esc_attr_e('image', 'leven-portfolio'); ?>"/>
				                                                <?php endforeach ?>
				                                            </div>
				                                ...
				                                <div class="col-sm-12 col-md-4 portfolio-block<?php if ($portfolio_sidebar_position == "left") { ?> order-first mb-4<?php } ?>">
				                                    ...
				                                    <div class="project-description">
					                                    <div class="block-title">
				                                            ...
				                                            <?php } else { ?>
				                                            <h3><?php esc_html_e( 'Description', 'leven-portfolio' ); ?></h3>
				                                            <?php } ?>
					                                    </div>
					                                    ...
					                                    ?>
						                                    ...
						                                    <div class="tags-block">
						                                        <div class="block-title">
						                                            ...
						                                            <?php } else { ?>
						                                            <h3><?php esc_html_e( 'Technology', 'leven-portfolio' ); ?></h3>
						                                            <?php } ?>
						                                        </div>
						                                        <ul class="tags">
																	<?php foreach (fw_get_db_post_option($post->ID, 'portfolio_type/standard/pf_tags', '') as $leven_project_tags): ?>

																		   <li><a><?php echo esc_html($leven_project_tags); ?></a></li>
														...
														<?php if ( function_exists( 'leven_theme_share_buttons' ) && $share_buttons_show == "1" ) : ?>
															<!-- Share Buttons -->
															<div class="share-buttons">
																<div class="block-title">
						                                            ...
						                                            <?php } else { ?>
						                                            <h3><?php esc_html_e( 'Share', 'leven-portfolio' ); ?></h3>
						                                            <?php } ?>
																</div>
																<div class="btn-group">
																	<?php leven_theme_share_buttons($permalink); ?>
																</div>
															</div>
															<!-- /Share Buttons -->
														<?php endif; ?>
