...
function leven_portfolio_post_thumbnail_sizes_attr($attr, $attachment, $size) {
...
add_filter('wp_get_attachment_image_attributes', 'leven_portfolio_post_thumbnail_sizes_attr', 10 , 3);

function leven_loadmore_ajax_handler(){
    global $post;
    $layout = $atts['layout'];
...
add_action('wp_ajax_loadmore', 'leven_loadmore_ajax_handler');
add_action('wp_ajax_nopriv_loadmore', 'leven_loadmore_ajax_handler');

/**
 * LMPixels custom taxonomy in the Gutenberg
 */
function leven_portfolio_taxonomy_gutenberg() {
    $mytax = get_taxonomy( 'fw-portfolio-category' );
    $mytax->show_in_rest = true;
}

add_action( 'init', 'leven_portfolio_taxonomy_gutenberg', 30 );
/* ================================================================================================ */
